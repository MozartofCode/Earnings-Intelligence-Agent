...
SECRET_KEY = os.getenv('DJANGO_SECRET_KEY', 'django-insecure-ng08#-jibkdvpo6#ty&flmc5#-*bd$++i7_prp87t@w@5^!#ds')
...
# Defaults to local SQLite. Set DATABASE_URL (e.g. postgres://user:pass@host:port/db)
